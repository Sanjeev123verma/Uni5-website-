...
// const Dashboard = () => {
//   return (
//     <div className="w-[80%] text-white py-16 flex flex-col items-center">
//       {/* Heading Section */}
...
//       <div className="w-11/12 max-w-6xl mt-12 bg-stone-900 rounded-xl p-4 flex flex-col md:flex-row gap-6">
...
//         <div className="w-full md:w-[80%] flex justify-center items-center bg-stone-800 rounded-2xl">
//           <img
//             src={dashboardImage}
//             alt="Dashboard"
//             className="md:h-[400px] rounded-2xl p-2"
//           />
//         </div>
//       </div>
//     </div>
...
const Dashboard = () => {
  return (
    <div className="w-full sm:w-11/12 md:w-9/10 lg:w-4/5 xl:w-4/5 max-w-[1280px] mx-auto px-2 sm:px-2 lg:px-2 text-white py-16 flex flex-col items-center">
      {/* Heading Section */}
      <button className="mb-4 px-4 py-2 border bg-gradient-to-b from-stone-900 to-stone-800 rounded-lg">
        Why UNI5?
      </button>
      ...
      {/* Main Content Container */}
      <div className="w-full mt-12 bg-stone-900 rounded-xl p-4 sm:p-6 lg:p-8 flex flex-col md:flex-row gap-6">
        {/* Left Side: Feature Cards */}
        <div className="flex flex-col gap-2 w-full md:w-1/2">
          <FeatureCard
            title="Attendance & Time"
        ...
        {/* Right Side: Dashboard Image */}
        <div className="w-full md:w-1/2 flex justify-center items-center bg-stone-800 rounded-2xl">
          <img
            src={dashboardImage}
            alt="Dashboard"
            className="md:h-[400px] rounded-2xl p-2"
